...
T_{1>2} = \Big(\frac{\frac{\bar{G}^2}{\bar{S}^2}+r_1\bar{G}}{\frac{\bar{G}^2}{\bar{S}^2}+r_2\bar{G}}\Big)^{\frac{\bar{G}^2}{\bar{S}^2}} \\

T_{1>2} = \Big(\frac{\bar{G}+r_1\bar{S}^2}{\bar{G}+r_2\bar{S}^2}\Big)^{\frac{\bar{G}^2}{\bar{S}^2}}
